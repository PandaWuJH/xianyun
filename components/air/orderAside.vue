<template>
    <div class="aside">
        ...
        <el-row type="flex" justify="space-between" class="info-bar">
            ...
            <span>x{{obj.people}}</span>
        </el-row>
        <el-row type="flex" justify="space-between" class="info-bar">
            <span>机建＋燃油</span>
            <span>¥{{data.airport_tax_audlet}}/单程</span>
            <span>x{{obj.people}}</span>
        </el-row>
        <el-row type="flex" justify="space-between" align="middle" class="info-bar">
            <span>应付总额：</span>
            <span class="price">￥{{obj.amount}} </span>
        </el-row>           
        <!-- <button @click="deal">按钮获取数据</button> -->
    </div>
</template>
...
export default {
    props: {
        ...
        obj:{
            type: Object,
            default: {}//有总价和人数{amount,people:this.orderForm.users.length}
        }
    },
